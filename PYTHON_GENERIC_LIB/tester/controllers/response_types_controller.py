...
class ResponseTypesController(BaseController):
    ...
    def get_date_array(self):
        ...
        decoded = [dateutil.parser.parse(element).date() for element in APIHelper.json_deserialize(_response.text)]
    ...
    def get_date(self):
        ...
        decoded = dateutil.parser.parse(_response.text).date()
    ...
    def return_company_model(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, Company.from_dictionary)
    ...
    def return_boss_model(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, BossCompany.from_dictionary)
    ...
    def return_employee_model(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, EmployeeComp.from_dictionary)
    ...
    def return_developer_model(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, Developer.from_dictionary)
    ...
    def return_tester_model(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, SoftwareTester.from_dictionary)
    ...
    def return_complex_1_object(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, Complex1.from_dictionary)
    ...
    def return_response_with_enums(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, ResponseWithEnum.from_dictionary)
    ...
    def return_complex_2_object(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, Complex2.from_dictionary)
    ...
    def return_complex_3_object(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, Complex3.from_dictionary)
    ...
    def get_model(self):
        ...
        decoded = APIHelper.json_deserialize(_response.text, Person.from_dictionary)
    ...
    def get_3339_datetime(self):
        ...
        decoded = APIHelper.RFC3339DateTime.from_value(_response.text).datetime
    ...
    def get_3339_datetime_array(self):
        ...
        decoded = [element.datetime for element in APIHelper.json_deserialize(_response.text, APIHelper.RFC3339DateTime.from_value)]
    ...
    def get_1123_date_time(self):
        ...
        decoded = APIHelper.HttpDateTime.from_value(_response.text).datetime
    ...
    def get_unix_date_time(self):
        ...
        decoded = APIHelper.UnixDateTime.from_value(_response.text).datetime
    ...
    def get_1123_date_time_array(self):
        ...
        decoded = [element.datetime for element in APIHelper.json_deserialize(_response.text, APIHelper.HttpDateTime.from_value)]
    ...
    def get_unix_date_time_array(self):
        ...
        decoded = [element.datetime for element in APIHelper.json_deserialize(_response.text, APIHelper.UnixDateTime.from_value)]
